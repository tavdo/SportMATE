...
export const en = {
  ...
  onboarding: {
    ...
    phoneSubtitle: "Enter your number and password — no SMS code",
  ...
  session: {
    ...
    finishGameHint: "Optionally check players who didn't show, then finish",
    gameFinished: "Game stats updated",
    noShowSaved: "Updated",
    venue: "Venue",
    dateTime: "Time",
    note: "Note",
